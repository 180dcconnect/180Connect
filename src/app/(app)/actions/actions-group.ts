 ...
 * tab that would bounce them to the dashboard — Team tasks is admin-only.
 */
export const ACTIONS_TABS = [
  { href: "/actions", label: "My tasks", permission: "client:view" },
  { href: "/admin/actions", label: "Team tasks", permission: "user:manage" },
...
export function actionsTabsFor(role: AppRole): GroupTabsSpec {
  // "My tasks" lists work assigned to you, and nothing is ever assigned to a
  // viewer — leadership gets Team tasks, where the whole team's work is.
