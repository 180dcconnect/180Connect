-- Rollback for 20260913090000_notify_reply_owner.sql (F174, #170).
--
-- Restores capture_gmail_reply to its exact 20260912170100 body — no
-- notification call, no owner lookup. Nothing else changes: no table, grant
-- or column was added by the forward migration, so there is nothing else to
-- undo. Any NOTIFICATIONS rows already produced with
