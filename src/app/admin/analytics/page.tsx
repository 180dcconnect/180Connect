...
export default async function AdminAnalyticsPage() {
  ...
  // at all. Stated on the page rather than dropped: teamTotals sums per-CAM
  // rows, so without this they left every figure with nothing to show they had.
  const uncounted = uncountedClients(rows, camList);
  const uncountedMessage = describeUncountedClients(uncounted);
