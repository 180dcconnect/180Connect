  ...
  return (
    <section className="mt-6 rounded-xl border border-black/10 bg-gray-50 p-5 shadow-xs">
      ...
      <form action={action} className="mt-4 flex flex-wrap items-end gap-3">
        ...
        <button
          className="inline-flex items-center justify-center rounded-lg bg-brand px-5 py-2.5 text-sm font-bold text-white transition-opacity hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-50"
          disabled={pending}
          type="submit"
        >
          {pending ? (
