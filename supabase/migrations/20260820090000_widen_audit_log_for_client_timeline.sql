...
-- Story: F075 — View Communication Timeline
...
--   (reassign_ownership, 20260804170000) — so AC1/AC4 can render them and
--   AC3's realtime subscription can actually receive them (RLS gates
