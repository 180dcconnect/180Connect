...
import { formatDueDate, formatMyActions, isActionOverdue, type ActionRow } from "./actions.ts";
...
describe("formatMyActions", () => {
  ...
  it("treats a null creator as system-generated (F160-style, once wired)", () => {
    const [action] = formatMyActions(
