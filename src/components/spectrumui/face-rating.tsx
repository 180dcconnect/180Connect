  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-label={label}
        className={cn(
          "flex items-center p-1 rounded-full bg-black/[0.04] dark:bg-white/[0.06] backdrop-blur-md border border-black/[0.06] dark:border-white/[0.08] shadow-inner",
          sizes.row
        )}
        ...
        {LEVELS.map((segmentLevel) => {
          ...
          return (
            ...
            >
              ...
              <span className="relative z-10" style={{ color: isActive ? color : undefined }}>
                {segmentLevel}
              </span>
            </motion.button>
          )
