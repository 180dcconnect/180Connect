...
| `count_salary_band_*` (16 fields, £60k–£500k+) | **Never read.** The adapter does not carry them into the payload and there is no column for them | Aggregate in form only: "1 employee in the £450,001–£500,000 band" at a small charity identifies a specific person. Fails the identifiability test in `docs/data-lifecycle-policy.md` §5.7. See `20260923112000_add_charity_scale_and_govt_funding.sql` |
