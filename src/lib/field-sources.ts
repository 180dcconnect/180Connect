...
export type FieldSourceRow = {
  ...
  is_current: boolean;
  recorded_at: string;
  /** The user whose action produced this value (20260922104000). Null = pipeline. */
...
// field_sources check constraint (organisation_type joined in 20260922104000) —
...
// ---------------------------------------------------------------------------
// The Activity tab's "What came from where" card (20260922104000).
//
