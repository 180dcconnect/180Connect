 ...
 *
 * F172 — Overdue Action Warning: grouped by urgency (overdue first, then
 * upcoming, then undated) rather than one flat feed — AC1/AC2. See
 * @/lib/actions's groupMyActionsByDueDate and actions-list.tsx's destructive
 * styling on the "Overdue" section. AC3 ("also surface in the Needs
 * Attention panel") is met on the dashboard, not here — see
 * @/lib/dashboard-metrics's needsAttention and @/components/attention-list,
 * both of which reuse isActionOverdue from this same file so "overdue" means
 * one thing everywhere it's shown.
 *
