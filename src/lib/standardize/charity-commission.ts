...
function computeCompletenessScore(org: Omit<StandardOrganisation, "data_completeness_score">): number {
  // TODO: this is a first-pass, unweighted heuristic (filled fields / total
  // scoreable fields), not a spec — the Data Model doesn't define how this
  // score should be calculated. Revisit once that's documented; some fields
  // (e.g. legal_name) likely matter more than others for "complete enough to
  // act on".
