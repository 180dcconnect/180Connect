...
-- Reverts both claim RPCs to the UTC window they used before. The F018
-- owner-or-admin-or-author-while-unowned predicate is kept: rolling back to
-- the pre-F018 rule would silently reopen direct-API sends on owned clients.
