  ...
  return (
    <div className="min-h-screen max-w-full overflow-x-hidden bg-[#f4f4ef] px-4 py-8 sm:px-8 sm:py-10 xl:px-12 xl:py-12">
      <div className="mx-auto w-full max-w-[1400px] space-y-10">
        ...
        {/* Hero metrics: ProgressMetricCard + SegmentationCard side-by-side */}
        <div aria-hidden="true" className="grid grid-cols-1 gap-4 xl:grid-cols-12 items-stretch">
          ...
          <div className="xl:col-span-4">
            <div className="relative flex min-h-[320px] w-full animate-pulse flex-col justify-between overflow-hidden rounded-[28px] border border-black/[0.06] bg-white p-6 shadow-sm sm:min-h-[460px]">
              <div className="flex items-center gap-2.5 pb-4 border-b border-black/[0.06]">
                <span className="h-7 w-7 rounded-lg bg-black/10" />
                <span className="h-5 w-36 rounded bg-black/10" />
              </div>
              <div className="mx-auto my-4 h-40 w-40 rounded-full border-8 border-black/5" />
              <div className="space-y-2 pt-4 border-t border-black/[0.04]">
                <span className="block h-6 w-full rounded bg-black/10" />
                <span className="block h-6 w-full rounded bg-black/10" />
                <span className="block h-6 w-full rounded bg-black/10" />
              </div>
            </div>
